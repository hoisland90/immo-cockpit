...
START_JAHR = 2026
# NEUER DATEINAME -> Zwingt die App zum Neuladen der Struktur!
...
# ==========================================
# 0. DATEN (ALLE OBJEKTE: TOP 4 + ARCHIV)
# ==========================================
DEFAULT_OBJEKTE = {
    # --- DIE TOP 4 (AKTIV) ---
    "Meckelfeld (Ziel-Preis 160k)": {
        ...
        "Marktmiete_m2": 13.45, "Energie_Info": "Gas (2022 neu), F",
    ...
    "Neu Wulmstorf (Neubau-Anker)": {
        ...
        "Miete_Start": 920, "Hausgeld_Gesamt": 260, "Kosten_n_uml": 60, 
        "Marktmiete_m2": 14.50, "Energie_Info": "Gas+Solar (Bj 2016), B",
    ...
    "Elmshorn (Terrasse & Staffel)": {
        ...
        "AfA_Satz": 0.02, "Mietsteigerung": 0.02, "Wertsteigerung_Immo": 0.02,
        "Miete_Start": 665, "Hausgeld_Gesamt": 370, "Kosten_n_uml": 165, 
        "Marktmiete_m2": 11.00, "Energie_Info": "Gas Bj 2012 (C)",
    ...
    "Harburg (Maisonette/Lifestyle)": {
        ...
        "Marktmiete_m2": 12.00, "Energie_Info": "Gas-Etage (D)",
    ...
    # --- DAS ARCHIV (VERGLEICHSOBJEKTE) ---
    "Buxtehude (5-Zi Volumen)": {
        "Adresse": "Stader Str., Buxtehude", "qm": 109.07, "zimmer": 5.0, "bj": 1972,
        "Kaufpreis": 236000, "Nebenkosten_Quote": 0.1057, "Miete_Start": 925, "Kosten_n_uml": 120,
        "AfA_Satz": 0.02, "Mietsteigerung": 0.02, "Wertsteigerung_Immo": 0.02, "Renovierung": 0, "Heizung_Puffer": 2000, "Hausgeld_Gesamt": 380,
        "Status": "Vermietet", "Link": "", "Bild_URLs": [], "PDF_Path": "", "Energie_Info": "F", "Marktmiete_m2": 10,
        "Archiviert": True, # ARCHIVIERT
    ...
    "Pinneberg-Thesdorf (2-Zi)": {
        "Adresse": "Thesdorf, Pinneberg", "qm": 59.0, "zimmer": 2.0, "bj": 1976,
        "Kaufpreis": 174000, "Nebenkosten_Quote": 0.085, "Miete_Start": 650, "Kosten_n_uml": 85,
        "AfA_Satz": 0.02, "Mietsteigerung": 0.02, "Wertsteigerung_Immo": 0.02, "Renovierung": 1500, "Heizung_Puffer": 0, "Hausgeld_Gesamt": 245,
        "Status": "Offen", "Link": "", "Bild_URLs": [], "PDF_Path": "", "Energie_Info": "D/E", "Marktmiete_m2": 11.50,
        "Archiviert": True, # ARCHIVIERT
        "Basis_Info": "Provisionsfrei, S-Bahn.", "Summary_Case": "Solider Cashflow.", "Summary_Pros": "Provisionsfrei.", "Summary_Cons": "Beton-Charme."
    },
    "Stade (4-Zi Leerstand)": {
        "Adresse": "Köhnshöhe, Stade", "qm": 87.0, "zimmer": 3.5, "bj": 1972,
        "Kaufpreis": 239000, "Nebenkosten_Quote": 0.07, "Miete_Start": 950, "Kosten_n_uml": 105,
        "AfA_Satz": 0.02, "Mietsteigerung": 0.02, "Wertsteigerung_Immo": 0.02, "Renovierung": 0, "Heizung_Puffer": 0, "Hausgeld_Gesamt": 286,
        "Status": "Leerstand", "Link": "", "Bild_URLs": [], "PDF_Path": "", "Energie_Info": "E", "Marktmiete_m2": 11.50,
        "Archiviert": True, # ARCHIVIERT
        "Basis_Info": "Leerstand = Marktmiete sofort.", "Summary_Case": "Cashflow-Case.", "Summary_Pros": "Leerstand, Top-Zustand.", "Summary_Cons": "Lage Hochhaus."
    },
    "Stade (Altbau-Schnapper)": {
        "Adresse": "Zentrum, Stade", "qm": 67.0, "zimmer": 2.0, "bj": 1905,
        "Kaufpreis": 159500, "Nebenkosten_Quote": 0.1057, "Miete_Start": 575, "Kosten_n_uml": 69,
        "AfA_Satz": 0.025, "Mietsteigerung": 0.02, "Wertsteigerung_Immo": 0.02, "Renovierung": 2000, "Heizung_Puffer": 5000, "Hausgeld_Gesamt": 170,
        "Status": "Vermietet", "Link": "", "Bild_URLs": [], "PDF_Path": "", "Energie_Info": "Gas-Etage", "Marktmiete_m2": 10,
        "Archiviert": True, # ARCHIVIERT
        "Basis_Info": "Heizung muss neu. Hohe AfA.", "Summary_Case": "Günstiger Einkauf.", "Summary_Pros": "Hohe AfA.", "Summary_Cons": "Heizungstausch."
    }
}
...
def load_data():
    if os.path.exists(DATA_FILE):
        with open(DATA_FILE, "r", encoding="utf-8") as f:
            data = json.load(f)
            # Merge: Nimm gespeicherte Daten, fülle mit neuen Defaults auf
            merged = data.copy()
...
if page == "📊 Portfolio Übersicht":
    ...
    # KPIs berechnen (immer nur für die angezeigten)
    ...
    with st.container(border=True):
        ...
        c3.metric("Anzahl Objekte", len(display_results))
    
    # Visualisierung (Bubble)
    ...
    with st.expander("⚙️ Parameter anpassen (Live)", expanded=True):
        ...
        if "Meckelfeld" in sel:
             st.caption("ℹ️ Fixe Mietstaffel aktiv")
             new_m = curr_m
        else:
